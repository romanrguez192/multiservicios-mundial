    ...
    <>
      <Carousel defaultWait={7000}>
        ...
        <Fade>
          ...
          <h2>Recuerda siempre que la naturaleza nunca ha traicionado a quien la ha amado</h2>
        </Fade>
      </Carousel>
      <Typography className={classes.footer}>
        Desarrolladores: Román Rodríguez, José Saad, Miguelangelo Sumoza, Mónica Cuaulma
      </Typography>
    </>
  );
};
